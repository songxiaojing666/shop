...
<select onchange="changePageSize(this.value);" style="width:100px;opacity:100;border:1px solid #ccc" id="pagesize">
<option value="3" ${page.pageSize==5?"selected":"" }>每页3条</option>
